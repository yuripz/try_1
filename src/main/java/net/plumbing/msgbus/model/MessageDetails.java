...
public class MessageDetails {
    ...
    public RowId ROWID_QUEUElog=null;
    ...
    public  MessageDetails() {
        ...
        this.Soap_HeaderRequest.setLength(0); this.XML_MsgClear.trimToSize();
        this.XML_Request_Method.setLength(0); this.XML_MsgClear.trimToSize();
